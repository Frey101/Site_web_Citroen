...
*   **Analyse de l'Environnement (PESTEL & Porter) :** Étude de l'impact macro-environnemental (politiques fiscales, bonus écologiques, transition électrique) et micro-environnemental (intensité concurrentielle avec Dacia, Renault, Peugeot et Volkswagen).
*   **Analyse de la Demande :** Typologie des acheteurs selon les gammes (thermique vs électrique), budgets moyens et fidélité à la marque.
...
*   Création d'une charte graphique numérique (couleurs, typographies, hiérarchie).
*   Déclinaison des interfaces en **Desktop** et **Mobile** (approche responsive).
...
*   **CSS3 :** Stylisation sur-mesure, gestion fine des mises en page (Flexbox / Grid CSS), respect au pixel près de la maquette Figma.
*   **Responsive Web Design :** Configuration des *media queries* pour s'assurer que le site s'adapte parfaitement sur tous les types d'écrans (ordinateurs, tablettes, smartphones).

---

## 🛠️ Technologies & Outils Utilisés
*   **Analyse de Gestion :** Modèles SWOT, PESTEL, 5 Forces de Porter
*   **Design & UI/UX :** Figma
